...
class Utility {
	...
	public static function os() {
		if (self::match('/Darwin|iPod|iPhone|iPad/i', self::getUserAgent()) === true) {
			$os = 'ios';
		} else if (self::match('/Android/i', self::getUserAgent()) === true) {
			$os = 'android';
		} else {
			$os = 'web';
		}
	...
	public static function processLock($singleton = false) {
		...
		if ($singleton === true && GlobalCache::exists($key) === true) {
			exit();
		}
